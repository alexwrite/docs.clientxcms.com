...
Vous pouvez définir dans les metadonnées du serveur Proxmox sur ClientXCMS la clé `proxmox_url` avec la valeur `proxmox.example.com` si vous utilisez un proxmox local pour indiquer l'URL du proxmox.
